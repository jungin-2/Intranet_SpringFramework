...
function mbrDelete() {
	...
	if(confirm("사용자 탈퇴를 하시면 작성하셨던 모든 게시물도 함께 삭제됩니다. \n정말로 사용자 탈퇴 하시겠습니까?") == true)
	 	{ alert("사용자 정보기 삭제 되었습니다."); document.location.href='/memberOut.jsp';  } 	
}
...
<div class="main" align="center">
    ...
    <div class="viewMemberInfo">
        <h1 style="text-align:center;">사용자 정보</h1>
         ...
         <div class="regdate">서비스 가입일 : ${member.regdate}</div>
         <div class="lastlogindate">마지막 로그인 일자 : ${member_date.lastlogindate}</div>
    ...
    <div class="bottom_menu" align="center">
        ...
        <a href="/member/memberInfoPasswordModify">패스워드 변경</a> &nbsp;&nbsp;
