...
function sendFileToServer()
{
	...
	var uploadURL = "/board/fileUpload?seqno=${view.seqno}&kind=U"; 
...
<div class="FormDiv">
	...
	<form id="ModifyForm" method="POST" >
		...
		<input type="text" id="mtitle" name="mtitle"  value="${view.mtitle}">
		...
		<textarea id="mcontent" cols="100" rows="500" name="mcontent">${view.mcontent}</textarea>
         	...
         	<div id="fileList">	
         		<p style="text-align:left;">
        	 		<c:forEach items="${fileListView}" var="file" >
         				&nbsp&nbsp&nbsp&nbsp<input type="checkbox" id="deleteFileList" name="deleteFileList" value="${file.fileseqno}"> 
	...
	<input type="button" class="btn_write" value="등록" onclick="ModifyForm()" />
